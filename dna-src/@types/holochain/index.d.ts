...
declare function getBridges(): any[];
...
declare function get(hash: Hash, options?: object): any;
declare function getLinks(base: Hash, tag: string, options?: object): any[];
...
declare function query(options?: object): any[];
